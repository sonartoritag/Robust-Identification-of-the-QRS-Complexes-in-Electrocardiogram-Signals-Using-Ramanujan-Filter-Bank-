...
def RFB(samf, xx, Pmax, Rcq, Rav, Th, sigma=40):
    """
    Ramanujan Filter Bank with Gaussian smoothing and R-Peak Detection.
    ...
    Pmax : int
        Maximum period for Ramanujan filters
    Rcq  : int
        Replication factor for Ramanujan filter
    Rav  : int
        Replication factor for averaging filter
    Th   : float
    ...
    X_smooth       : Gaussian-smoothed envelope of filter output
    """
